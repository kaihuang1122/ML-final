...
if __name__ == '__main__':
    for units in range(6, 7):
        ...
        for epoch in range(2, 3):
            ...
            itr = [ (x, "hours/1002-1202", "hours/total[predict]", str(epoch), str(units), f"predict") for x in open("/Users/kaihuang1122/Documents/ML/Final/html.2023.final.data/sno_test_set.txt").readlines()[0:] ]
