...
meta_fix = dict()
for row in matrix_fix:
    meta_fix[row[0]] = row

    

ca_to_path = [(f'/Users/kaihuang1122/Documents/ML/Final/Data tidy/1202version/{x[:-1]}.csv', f'/Users/kaihuang1122/Documents/ML/Final/Combination/mixed/total[predict]/{x[:-1]}.csv') for x in open("/Users/kaihuang1122/Documents/ML/Final/html.2023.final.data/sno_test_set.txt").readlines()]
